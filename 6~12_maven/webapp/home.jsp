...
<div class="container" id="main">
    <div class="col-md-12 col-sm-12 col-lg-10 col-lg-offset-1">
        <%
            Collection<Question> questions = (Collection<Question>) request.getAttribute("questions");
        %>
        <div class="panel panel-default qna-list">
                    ...
                    <div class="wrap">
                        <div class="main">
                            <strong class="subject">
                                <a href= <%= "/question/show?questionId=" + question.getQuestionId()%>><%= question.getTitle()%>
                                </a>
                            </strong>
                            <div class="auth-info">
                                <i class="icon-add-comment"></i>
                                <span class="time"><%=question.getCreatedDate()%></span>
                                <a class="author" href=<%="/user/profile?userId=" + question.getWriter()%>><%=question.getWriter()%>
                                </a>
                            </div>
                            <div class="reply" title="댓글">
                                <i class="icon-reply"></i>
                                <span class="point"><%=question.getCountOfComment()%></span>
                            </div>
                        </div>
                    </div>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-md-3 qna-write">
                    <a href="/question/create" class="btn btn-primary pull-right" role="button">질문하기</a>
                </div>
            </div>
        </div>
    </div>
